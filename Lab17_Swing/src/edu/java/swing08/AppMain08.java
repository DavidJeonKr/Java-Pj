...
//				String input = JOptionPane.showInputDialog(frame, "나이는?", 0);
		...
		btnCustomDialog.setFont(new Font("Dialog", Font.PLAIN, 24));
		btnCustomDialog.setBounds(12, 258, 300, 52);
		frame.getContentPane().add(btnCustomDialog);
		
		JButton btnInputDlg_1_1 = new JButton("Custom Frame");
		btnInputDlg_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				MyFrame.showMyFrame();
			}
		});
		btnInputDlg_1_1.setFont(new Font("Dialog", Font.PLAIN, 24));
		btnInputDlg_1_1.setBounds(12, 320, 300, 52);
		frame.getContentPane().add(btnInputDlg_1_1);
