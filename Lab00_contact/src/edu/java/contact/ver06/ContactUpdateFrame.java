...
public class ContactUpdateFrame extends JFrame {
	...
	private ContactMain06 mainApp;
	/**
	 * Launch the application.
	 * @param frame 
	 */
	// Ctrl+Shift+O: 자동 import
	public static void showFrame(Component parentComponent, int index, ContactMain06 mainApp) {
	 ...
	 * Create the frame.
	 */
	public ContactUpdateFrame(Component parentComponent, int index, ContactMain06 mainApp) {
	...
	private void updateContact() {
		...
		if(result == 1) {
			dispose(); // 창 닫기                      //frame
			JOptionPane.showMessageDialog(parentComponent, "연락처 정보가 수정 되었습니다.");
