...
public class ContactInsertFrame extends JFrame {
	...
	private ContactMain06 mainApp; // 메인 화면(ContactMain05) 객체의 참조값을 저장하기 위한 변수

	/**
	 * Launch the application.
	 */
	public static void showFrame(Component parentComponent, ContactMain06 mainApp) {
	 ...
	 * Create the frame.
	 */
	public ContactInsertFrame(Component parentComponent, ContactMain06 mainApp) {
